  ...
  <div>
    <div class="my-24 grid max-w-7xl gap-16 sm:grid-cols-2 sm:gap-y-24 lg:items-center">
      <div>
        ...
        <p class="max-w-sm text-xl text-neutral-400">Use this project Starter Kit to build your collaborative app in minutes.</p>
        <div class="mt-6 flex flex-col gap-3 sm:flex-row">
          ...
          <UButton label="Learn more" variant="outline" color="neutral" to="https://github.com/roiLeo/Nuxtplate" taget="_blank" />
        </div>
      </div>
